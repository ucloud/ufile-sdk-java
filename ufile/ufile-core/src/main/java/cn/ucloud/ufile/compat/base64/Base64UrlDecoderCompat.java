...
public interface Base64UrlDecoderCompat {
    /**
     * Base64 URL解码
     * SDK内部凡是使用到该方法的部分，都需要确保其结果和 Java 1.8中 Base64.getUrlDecoder().decode(byte[]) 一致
     *
     * @param src 源byte
     * @return
     */
    ...
    /**
     * Base64 URL解码
     * SDK内部凡是使用到该方法的部分，都需要确保其结果和 Java 1.8中 Base64.getUrlDecoder().decode(String) 一致
     *
     * @param src 源byte
     * @return
     */
    byte[] urlDecode(String src);
}
